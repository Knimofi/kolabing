    ...
    >
      <div className="container mx-auto px-4 flex items-center justify-between">
        ...
        >
          ...
          <span
            style={NAV_FONT}
            className="text-[1.28rem] text-foreground select-none tracking-wide"
          >Kolabing</span>
        </div>
        ...
        <nav role="navigation" aria-label="Mobile navigation" className="flex flex-col p-6 space-y-2">
          <button
            ...
            className={cn(
              ...
              isActivePage('/') ? "text-primary border-l-4 border-primary" : "text-foreground"
            )}
          >
            How It Works
          </button>
          <button
            ...
            className={cn(
              "flex items-center py-4 px-4 text-lg transition-all duration-200 text-left w-full",
              isActivePage('/success-stories') ? "text-primary border-l-4 border-primary" : "text-foreground"
            )}
          >
            Success Stories
          </button>
          <button
            ...
            className={cn(
              "flex items-center py-4 px-4 text-lg transition-all duration-200 text-left w-full",
              isActivePage('/our-communities') ? "text-primary border-l-4 border-primary" : "text-foreground"
            )}
          >
            Our Communities
          </button>
          ...
          {user ? (
            <button
              ...
              style={NAV_FONT}
              className="flex items-center py-4 px-4 text-lg transition-all duration-200 text-left w-full text-primary"
            >
              Dashboard
            </button>
          ) : (
