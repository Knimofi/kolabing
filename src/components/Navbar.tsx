...
const Navbar = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 py-4 backdrop-blur-md shadow-sm bg-gradient-to-r from-blue-950/90 to-slate-900/90">
      ...
      >
        ...
        {/* Mobile menu items */}
        <nav className="flex flex-col p-6 space-y-2" role="navigation" aria-label="Mobile navigation">
          <button
            onClick={scrollToTop}
            className={cn(
          ...
          <button
            ...
            className="flex items-center py-4 px-4 text-lg font-medium rounded-xl transition-all duration-200 text-left w-full text-foreground hover:text-primary hover:bg-muted focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
          >
            About
          </button>
