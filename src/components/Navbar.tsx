        ...
        <nav className="hidden md:flex space-x-6">
          ...
          if (profile?.user_type === 'business') {
            ...
            navigate('/community');
              ...
              Dashboard
            </button> : <button className="text-muted-foreground hover:text-foreground transition-colors" onClick={() => navigate('/auth/sign-in')}>
              Sign In
            </button>}
        </nav>

        {/* Mobile menu button */}
        <button className="md:hidden text-foreground p-2 focus:outline-none" onClick={toggleMenu} aria-label={isMenuOpen ? "Close menu" : "Open menu"}>
