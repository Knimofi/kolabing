...
export const DashboardClassNames = {
  ...
  searchInput: "w-full bg-[#F5F5F5] text-[#222] border border-[#E0E0E0] rounded-lg px-3 py-2.5 pl-10 font-['Open_Sans'] text-[14px] focus:outline-none focus:border-[#E8D7A0] focus:shadow-[0_0_0_3px_rgba(255,246,216,0.4)]",
