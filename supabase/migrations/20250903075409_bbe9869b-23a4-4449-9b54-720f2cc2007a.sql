...
DROP POLICY IF EXISTS "Offer photos are publicly accessible" ON storage.objects;
DROP POLICY IF EXISTS "Users can upload their own offer photos" ON storage.objects;
DROP POLICY IF EXISTS "Users can update their own offer photos" ON storage.objects;
DROP POLICY IF EXISTS "Users can delete their own offer photos" ON storage.objects;
